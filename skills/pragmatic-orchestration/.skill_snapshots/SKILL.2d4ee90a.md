...
"$CONSILIUM" review ask --progress compact -a codex,grok,claude-fable --prompt-file prompt.md
...
"$CONSILIUM" explore --repo owner/repository --ref main "How are plugins loaded?"
